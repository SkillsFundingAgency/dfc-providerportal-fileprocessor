...
namespace Dfc.CourseDirectory.Services.CourseService
{
    public class CourseService : ICourseService
    {
        ...
        //private readonly HttpClient _httpClient;   // HTTPClient doesn't like being injected in async code - getting "object disposed" exception
        ...
        public async Task<IResult<ICourse>> GetCourseByIdAsync(IGetCourseByIdCriteria criteria)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync(new Uri(_getCourseByIdUri.AbsoluteUri + "?id=" + criteria.Id));
        ...
        public async Task<IResult<ProviderAzureSearchResults>> ProviderSearchAsync(ProviderSearchCriteria criteria)
        {
            ...
            try
            {
                ...
                if (!httpClient.DefaultRequestHeaders.Any(h => h.Key == "UserName"))
                    httpClient.DefaultRequestHeaders.Add("UserName", _apiUserName);
                if (!httpClient.DefaultRequestHeaders.Any(h => h.Key == "Password"))
                    httpClient.DefaultRequestHeaders.Add("Password", _apiPassword);
                ...
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.PostAsync(_providerSearchUri, content);
        ...
        public async Task<IResult<IEnumerable<ICourseStatusCountResult>>> GetCourseCountsByStatusForUKPRN(ICourseSearchCriteria criteria)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(new Uri(_getCourseCountsByStatusForUKPRNUri.AbsoluteUri + "?UKPRN=" + criteria.UKPRN));
        ...
        public async Task<IResult<IEnumerable<ICourse>>> GetRecentCourseChangesByUKPRN(ICourseSearchCriteria criteria)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(new Uri(_getRecentCourseChangesByUKPRNUri.AbsoluteUri + "?UKPRN=" + criteria.UKPRN));
        ...
        public async Task<IResult<ICourse>> AddCourseAsync(ICourse course)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.PostAsync(_addCourseUri, content);
        ...
        public async Task<IResult<ICourse>> UpdateCourseAsync(ICourse course)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.PostAsync(_updateCourseUri, content);
        ...
        public async Task<IResult> ArchiveProviderLiveCourses(int? UKPRN)
        {
            ...
            HttpClient httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
            var response = await httpClient.GetAsync(new Uri(_archiveLiveCoursesUri.AbsoluteUri + "?UKPRN=" + UKPRN));
        ...
        public async Task<IResult> UpdateStatus(Guid courseId, Guid courseRunId, int statusToUpdateTo)
        {
            ...
            HttpClient httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
            var response = await httpClient.GetAsync(new Uri(_updateStatusUri.AbsoluteUri
                + "?CourseId=" + courseId
        ...
        public async Task<IResult<CourseMigrationReport>> GetCourseMigrationReport(int UKPRN)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(new Uri(_getCourseMigrationReportByUKPRN.AbsoluteUri + "?UKPRN=" + UKPRN));
        ...
        public async Task<IResult<IList<DfcMigrationReport>>> GetAllDfcReports()
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(new Uri(_getAllDfcReports.AbsoluteUri));
                _logger.LogHttpResponseMessage("Get course migration report service http response", response);
