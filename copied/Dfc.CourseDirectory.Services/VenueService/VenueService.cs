    ...
    public class VenueService : IVenueService
    {
        ...
        public async Task<IResult<IVenue>> GetVenueByIdAsync(IGetVenueByIdCriteria criteria)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(_getVenueByIdUri.AbsoluteUri + $"?id={criteria.Id}");
        ...
        public async Task<IResult<IVenue>> GetVenueByLocationIdAsync(IGetVenueByLocationIdCriteria criteria)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.GetAsync(_getVenueByLocationIdUri + $"?LocationId={criteria.LocationId}");
        ...
        public async Task<IResult<IVenue>> AddAsync(IVenue venue)
        {
            ...
            try
            {
                ...
                HttpClient httpClient = new HttpClient();
                httpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.ApiKey);
                var response = await httpClient.PostAsync(_addVenueUri, content);
